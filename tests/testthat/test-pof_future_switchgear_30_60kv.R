...
context("Future Probability of Failure for Switchgear 30 60 kv pex")

test_that("pof_future_switchgear_30_60kv", {

  res <-  pof_future_switchgear_30_60kv(
     asset_type = "30kV",
  ...
  expected_value <- readRDS(system.file("testdata/pof_future_switchgear_30_60kv.rds", package =
                                          "CNAIM"))
