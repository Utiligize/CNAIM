...
context("Future Probability of Failure for Relay")

test_that("pof_future_relay", {

  res <-  pof_future_relay(
     placement = "Default",
     altitude_m = "Default",
  ...
  expected_value <- readRDS(system.file("testdata/pof_future_relay.rds", package =
                                          "CNAIM"))
