...
context("Future Probability of Failure for Switchgear Secondary 10 kv")

test_that("pof_future_switchgear_secondary_10kv", {

  res <-  pof_future_switchgear_secondary_10kv(
     placement = "Default",
     altitude_m = "Default",
  ...
  expected_value <- readRDS(system.file("testdata/pof_future_switchgear_secondary_10kv.rds", package =
                                          "CNAIM"))
