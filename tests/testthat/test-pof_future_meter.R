...
context("Future Probability of Failure for Meter")

test_that("pof_future_meter", {

  res <-  pof_future_meter(
     placement = "Default",
     altitude_m = "Default",
  ...
  expected_value <- readRDS(system.file("testdata/pof_future_meter.rds", package =
                                          "CNAIM"))
