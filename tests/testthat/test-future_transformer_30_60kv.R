...
context("Future Probability of Failure for Transformer 30 60 kv")

test_that("pof_future_transformer_30_60kv", {

  res <-  pof_future_transformer_30_60kv(transformer_type = "60kV Transformer (GM)",
  ...
  expected_value <- readRDS(system.file("testdata/pof_future_transformer_30_60kv.rds", package =
                                          "CNAIM"))
