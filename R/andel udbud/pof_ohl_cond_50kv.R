...
#' \code{visual_cond = c("No deterioration","Superficial/minor deterioration",
#' "Some Deterioration",
...
#' @param k_value Numeric. \code{k_value = 0.0080} by default. This number is
...
# paste0(sprintf("Probability of failure %.4f", pof_ohl_cond_50kV_res),
# " percent per annum")
