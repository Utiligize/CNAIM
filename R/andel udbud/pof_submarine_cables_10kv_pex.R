#' @importFrom magrittr %>%
#' @title Current Probability of Failure for 10kV Non Pressurised Submarine Cables
...
#' Options:
#' \code{sub_cable_type = "HV Sub Cable"}.
#' The deafult setting is \code{sub_cable_type = "HV Sub Cable"}.
...
#' @param k_value Numeric. \code{k_value = 0.0202} by default. This number is
...
#' @export
#' @examples
#' # Current annual probability of failure for 1 km 10kV Sub Cable
# pof_submarine_cables_10kv_pex_res <-
# pof_submarine_cables_10kv_pex(
...
# paste0(sprintf("Probability of failure %.4f", pof_submarine_cables_10kv_pex_res),
# " percent per annum")
