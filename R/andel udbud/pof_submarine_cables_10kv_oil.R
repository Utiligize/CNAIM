#' @importFrom magrittr %>%
#' @title Current Probability of Failure for 10kV Oil Submarine Cables
...
# pof_submarine_cables_10kv_oil_res <-
# pof_submarine_cables_10kv_oil(
...
# paste0(sprintf("Probability of failure %.4f", pof_submarine_cables_10kv_oil_res),
# " percent per annum")
