#' @importFrom magrittr %>%
#' @title Current Probability of Failure for 10kV UG PEX Non Pressurised Cables
...
# paste0(sprintf("Probability of failure %.4f", pof_cables_10kv_pex_res),
# " percent per annum")

pof_cables_10kv_pex <- function(utilisation_pct = "Default",
                                operating_voltage_pct = "Default",
                                sheath_test = "Default",
                                partial_discharge = "Default",
                                fault_hist = "Default",
