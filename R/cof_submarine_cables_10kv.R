...
financial_cof_submarine_cables_10kv <- function(gb_ref_given = NULL) {
...
safety_cof_submarine_cables_10kv <- function(gb_ref_given = NULL) {
...
environmental_cof_submarine_10kv <- function(gb_ref_given = NULL) {
