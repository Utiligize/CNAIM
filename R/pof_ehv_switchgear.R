#' @importFrom magrittr %>%
#' @title Current Probability of Failure for EHV Switchgear
...
pof_ehv_switchgear <-
  function(ehv_asset_category = "33kV RMU",
           placement = "Default",
           number_of_operations = "Default",
           altitude_m = "Default",
           distance_from_coast_km = "Default",
    ...
    pof_asset_category <- get_pof_ehv_asset_category(ehv_asset_category)
    ...
    duty_factor_cond <- get_duty_factor_hv_switchgear_primary(number_of_operations, gb_ref_taken)
...
get_pof_ehv_asset_category <- function(ehv_asset_category){
  if(grepl("66", ehv_asset_category, fixed = T)){
