#' @importFrom magrittr %>%
#' @title Current Probability of Failure for 30kV and 60kV Non Pressurised Submarine Cables
...
# paste0(sprintf("Probability of failure %.4f", pof_submarine_cables_30_60kv_pex_res),
# " percent per annum")
