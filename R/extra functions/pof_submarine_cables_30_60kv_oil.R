#' @importFrom magrittr %>%
#' @title Current Probability of Failure for 30kV and 60kV Oil Submarine Cables
...
# pof_submarine_cables_30_60kv_oil_res <-
# pof_submarine_cables_30_60kv_oil(
...
# paste0(sprintf("Probability of failure %.4f", pof_submarine_cables_30_60kv_oil_res),
# " percent per annum")
