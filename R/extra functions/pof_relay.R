#' @importFrom magrittr %>%
#' @title Current Probability of Failure for Relay
...
#' @export
#' @examples
#' # Current annual probability of failure for relay
# pof_relay_res <-
# pof_relay(
# placement = "Default",
# altitude_m = "Default",
...
# k_value = 0.128,
# c_value = 1.087,
# normal_expected_life = 30) * 100
# paste0(sprintf("Probability of failure %.4f", pof_relay_res),
# " percent per annum")
