#' @importFrom magrittr %>%
#' @title Future Probability of Failure for 132kV Transformers
...
#' @inheritParams pof_transformer_132kv
...
pof_future_transformer_132kv <- function(transformer_type = "132kV Transformer (GM)",
                                         year_of_manufacture,
                                         utilisation_pct = "Default",
                                         no_taps = "Default",
                                         placement = "Default",
  ...
  mci_132kv_tf_partial_discharge <-
    gb_ref_taken$mci_132kv_tf_main_tf_prtl_dis
  ...
  mci_132kv_tf_partial_discharge_tc <-
    gb_ref_taken$mci_132kv_tf_tpchngr_prtl_dis
  ...
  mci_132kv_tf_temp_readings <-
    gb_ref_taken$mci_132kv_tf_temp_readings
  ...
  oci_132kv_tf_main_tank_cond <-
    gb_ref_taken$oci_132kv_tf_main_tank_cond
  ...
  oci_132kv_tf_cooler_radiatr_cond <-
    gb_ref_taken$oci_132kv_tf_cooler_radtr_cond
  ...
  oci_132kv_tf_bushings_cond <-
    gb_ref_taken$oci_132kv_tf_bushings_cond
  ...
  oci_132kv_tf_kiosk_cond <-
    gb_ref_taken$oci_132kv_tf_kiosk_cond
  ...
  oci_132kv_tf_cable_boxes_cond <-
    gb_ref_taken$oci_132kv_tf_cable_boxes_cond
  ...
  oci_132kv_tf_tapchanger_ext_cond <-
    gb_ref_taken$oci_132kv_tf_tapchngr_ext_cond
  ...
  oci_132kv_tf_int_cond <-
    gb_ref_taken$oci_132kv_tf_int_cond
  ...
  oci_132kv_tf_drive_mechnism_cond <-
    gb_ref_taken$oci_132kv_tf_drive_mechsm_cond
  ...
  oci_132kv_tf_cond_select_divrter_cst <-
    gb_ref_taken$oci_132kv_tf_cond_select_div_c
  ...
  oci_132kv_tf_cond_select_divrter_brd <-
    gb_ref_taken$oci_132kv_tf_cond_select_div_b
