#' @importFrom magrittr %>%
#' @title Current Probability of Failure for 0.4kV Pillar
#' @description This function calculates the current
#' annual probability of failure for 0.4kV Pillar
...
#' @param k_value Numeric. \code{k_value = 0.0046} by default. This number is
...
# paste0(sprintf("Probability of failure %.4f", pof_pillar_04kv_res),
# " percent per annum")
